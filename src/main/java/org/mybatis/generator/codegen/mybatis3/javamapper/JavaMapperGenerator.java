...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addInsertOrUpdateSelectiveMethod(interfaze);
        addBatchInsertMethod(interfaze);
        addUpdateBatchMethod(interfaze);
        addUpdateBatchSelectiveMethod(interfaze);
    ...
    protected void addUpdateBatchMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUpdateByPrimaryKeySelective()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new UpdateBatchMethodGenerator();
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }

    protected void addUpdateBatchSelectiveMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateUpdateByPrimaryKeySelective()) {
