...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setInsertOrUpdateStatementId("insertOrUpdate"); //$NON-NLS-1$
        setInsertOrUpdateSelectiveStatementId("insertOrUpdateSelective"); //$NON-NLS-1$
        setBatchInsertStatementId("batchInsert"); //$NON-NLS-1$
        setUpdateBatchStatementId("updateBatch"); //$NON-NLS-1$
        setUpdateBatchSelectiveStatementId("updateBatchSelective"); //$NON-NLS-1$
    }
    ...
    public void setUpdateBatchSelectiveStatementId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_UPDATE_BATCH_SELECTIVE_STATEMENT_ID, s);
    }
